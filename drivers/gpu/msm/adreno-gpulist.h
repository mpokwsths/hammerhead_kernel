...
static const struct adreno_gpulist {
	...
	{
		.gpurev = ADRENO_REV_A220,
		.core = 0,
		.major = 2,
		.minor = 1,
		.patchid = ANY_ID,
		.pm4fw = "leia_pm4_470.fw",
		.pfpfw = "leia_pfp_470.fw",
		.gpudev = &adreno_a2xx_gpudev,
		.gmem_size = SZ_512K,
		.sync_lock_pm4_ver = NO_VER,
		.sync_lock_pfp_ver = NO_VER,
	},
	{
		...
		.gpudev = &adreno_a2xx_gpudev,
		.gmem_size = SZ_512K,
		.sync_lock_pm4_ver = 0x225011,
		.sync_lock_pfp_ver = 0x225002,
	},
	{
