...
module_param_named(temp_hysteresis_degC,
			msm_thermal_info.temp_hysteresis_degC,
			int, 0664);
module_param_named(freq_step, msm_thermal_info.bootup_freq_step, uint, 0664);
...
module_param_named(hotplug_temp_hysteresis,
		   msm_thermal_info.hotplug_temp_hysteresis_degC, uint, 0664);
module_param_named(psm_temp,
		   msm_thermal_info.psm_temp_degC, uint, 0664);
module_param_named(psm_temp_hysteresis,
		   msm_thermal_info.psm_temp_hyst_degC, uint, 0664);
